main.controller('adminsearchCtrl', ['$scope', '$http',"NgTableParams", 'generalData', function ($scope, $http, NgTableParams, $generalData) {
 ...
 $scope.updatePerformance = function(){
    $http.post("/proxy/performance", { user: 'ciro', password: 'password'},JSON.stringify({context: $scope.context})).
